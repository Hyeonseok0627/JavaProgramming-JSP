...
<body>
	...
	<div class="container" align="center">
		<div class="col-md-4 col-md-offset-4">
			...
			%>
			<%--action="j_security_check" : 이렇게 해줘야지 tomcat-users.xml에 있는 user, password등의 보안 정보 확인으로 가게 되어서 밑에 유저네임도 확인이 가능 --%>
			<form class="form-singin" action="j_security_check" method="post">
				...
				<div class="form-group">
					<label for="intputPassword" class="sr-only">Password
					</label>
					<input type="password" class="form-control" placeholder=
					"Password" name='j_password' required>
				</div>
